 ...
 * trade in the electricity market (EPEX SPOT style).
 *
 ...
 * @param price Limit price in EUR/MWh (0.01 - 500.00, max 2 decimal places)
 * @param type Order type: "BUY" or "SELL"
 * @param quantity Amount in MWh (0.1 - 1000.0, max 1 decimal place)
 */
public record Order(
    ...
    @NotNull(message = "Price cannot be null")
        ...
        @Digits(integer = 6, fraction = 2, message = "Price cannot have more than 2 decimal places")
        BigDecimal price,
    ...
    @NotNull(message = "Quantity cannot be null")
        ...
        @Digits(
            integer = 7,
            fraction = 1,
            message = "Quantity cannot have more than 1 decimal place")
        BigDecimal quantity) {}
